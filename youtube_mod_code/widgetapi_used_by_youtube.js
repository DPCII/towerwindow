(function () {
    ...
    function Ma(a) {
        var b = new H(Ja, G instanceof F && G.constructor === F && G.a === Ia ? G.b : "type_error:Const");
        a.src = (b instanceof H && b.constructor === H && b.a === Ka ? b.b : "type_error:TrustedResourceUrl").toString()
    };
    ...
    function Qa() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == D.indexOf("Presto") && (a = function () {
            ...
            e = f.document;
            e.open();
            e.write(K instanceof I && K.constructor === I && K.b === La ? K.a : "type_error:SafeHtml");
            e.close();
        ...
        return "undefined" !== typeof document && "onreadystatechange" in L("SCRIPT") ? function (e) {
            var f = L("SCRIPT");
    ...
    function pb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function (h) {
                    h = new S(h);
                    if (!Oa(h.relatedTarget, function (p) {
                            return p == a
    ...
    function vb(a, b) {
        ...
        var c = va(b.getElementsByTagName("yt:" + a)),
            d = "yt-" + a,
            e = b || document;
        d = va(e.querySelectorAll && e.querySelector ? e.querySelectorAll("." + d) : Na(d, b));
        return ua(c, d)
    }
    ...
    function zb(a, b) {
        ...
        window.location.href && C(["debugjs", "debugcss"], function (p) {
            ...
            b: {
                var r = 0;
                for (var A = p.length; 0 <= (r = u.indexOf(p, r)) && r < ea;) {
